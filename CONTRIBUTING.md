# Contributing to nsis-action

First and foremost, thank you! We appreciate that you want to contribute to nsis-action, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for nsis-action**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for nsis-action:

- star the [project](https://github.com/joncloud/nsis-action)
- tweet your support for nsis-action
...
- **version**: (required) please note the version of nsis-action are you using
...
The original poster or the maintainers of nsis-action may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/nsis-action
