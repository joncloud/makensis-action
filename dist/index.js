...
const { F_OK } = (__nccwpck_require__(147).constants);

const path = __nccwpck_require__(17);
const makensis = __nccwpck_require__(598);
...
const path = __nccwpck_require__(17);
const { platform, env } = __nccwpck_require__(282);
...
const { getInput } = __nccwpck_require__(6);
const { fail } = __nccwpck_require__(904);
